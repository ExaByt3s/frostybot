...
const MARKET = 'ETH/USD';                       // Market to trade
const SYMBOL = 'ETHUSD';                        // Ticker
...
// it's recommended to use subaccounts for bots to limit your risk, but it's not needed and up to you.
