...
const MARKET = 'ETH-PERPETUAL';                 // Market to trade
const SYMBOL = 'ETH-PERPETUAL';                 // needed as some exchanges use different values for market and symbol
const DEFAULT_ORDER_SIZE = 1000;                // Default Order size in USD (if not specified in GET)
const MAX_POSITION_AS_PERC_OF_EQUITY = 500;     // maximum  position as a percentage of total balance. > 100 means bigger position than total equity allowed
